  ...
  const faqs = [
    {
      ...
      a: "Best-of-breed tools solve one department's problem and create five data silos. Kas newerax agents share one platform, one integration layer and one view of the customer or employee - so support, IT and HR are not working from disconnected systems that never talk to each other."
    },
    {
      q: "How long does it take to go live?",
      a: "Most agents go live in weeks, not quarters. We train on your existing docs, FAQs and workflows, then deploy in stages so your team can validate before it touches real customers or employees."
    },
    {
    ...
    },
    {
      ...
      a: "Kas newerax is ISO 27001 and SOC 2 aligned, and supports GDPR and HIPAA requirements - one data agreement and one access review covers every department's agent, instead of a separate one for every point tool you would otherwise buy."
    },
    {
      q: "Do we need an internal AI team to maintain this?",
      a: "No. A dedicated solution engineer owns your build through launch and stays on to optimise it, so this does not become another system your engineering team has to babysit."
    }
  ];
    ...
    <div className="w-full bg-white font-sans overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <motion.div variants={fadeInUp} className="w-full lg:w-1/2 flex flex-col items-start text-left">
            <p className="text-[#0ea5e9] font-bold text-[10px] mb-4 tracking-[0.2em] uppercase flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-[#0ea5e9]"></span> ONE PLATFORM. EVERY DEPARTMENT.
            </p>
            <h1 className="text-[3rem] leading-[1.1] sm:text-6xl lg:text-[4.5rem] font-bold text-[#14142b] tracking-tight mb-6">
              Stop buying a new AI vendor for every department
            </h1>
            <p className="text-lg text-gray-600 leading-relaxed max-w-xl mb-8">
              Support, IT, HR, sales and ops all end up on a different AI tool bought by a different team. Kas newerax builds custom agents for every one of those workflows on the platform you already run - one contract, one integration, one team that owns it.
            </p>
           
            <p className="mt-8 text-xs text-gray-400 font-medium tracking-wide flex flex-wrap gap-2 items-center">
              <span>500+ businesses</span> <span className="w-1 h-1 bg-gray-300 rounded-full"></span> 
              <span>one platform, every department</span> <span className="w-1 h-1 bg-gray-300 rounded-full"></span> 
            ...
            <div className="relative w-full max-w-md h-[400px] flex items-center justify-between pl-8">
               <div className="flex flex-col gap-5 z-10 w-40">
                  <div className="bg-white border border-gray-100 px-4 py-3 rounded-lg text-xs font-bold text-[#1e293b] shadow-sm flex items-center gap-3">
                     <div className="w-1.5 h-1.5 rounded-full bg-[#6039ea]"></div> SUPPORT
                  </div>
                  <div className="bg-white border border-gray-100 px-4 py-3 rounded-lg text-xs font-bold text-[#1e293b] shadow-sm flex items-center gap-3">
                     <div className="w-1.5 h-1.5 rounded-full bg-[#0ea5e9]"></div> IT HELPDESK
                  </div>
                  <div className="bg-white border border-gray-100 px-4 py-3 rounded-lg text-xs font-bold text-[#1e293b] shadow-sm flex items-center gap-3">
                     <div className="w-1.5 h-1.5 rounded-full bg-[#10b981]"></div> HR & POLICY
                  </div>
                  <div className="bg-white border border-gray-100 px-4 py-3 rounded-lg text-xs font-bold text-[#1e293b] shadow-sm flex items-center gap-3">
                     <div className="w-1.5 h-1.5 rounded-full bg-[#f59e0b]"></div> SALES & OPS
                  </div>
               </div>
      ...
      >
        <motion.div variants={fadeInUp} className="mb-16 max-w-3xl">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
            Five departments, five AI vendors, and no one owns the outcome
          </h2>
          <p className="text-lg text-gray-600 leading-relaxed">
            Companies between 300 and 1,000 employees do not plan to end up here. Support buys a chatbot, IT buys a helpdesk bot, HR buys a benefits assistant, sales buys another. Each works in isolation, none of them talk to each other, and no one owns the outcome company-wide.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div variants={fadeInUp} className="bg-white border border-gray-200 p-8 rounded-xl shadow-sm">
             ...
             <h3 className="text-lg font-bold text-gray-900 mb-3">A vendor contract per department</h3>
             <p className="text-gray-600 text-sm leading-relaxed">Five renewals, five invoices, five procurement cycles - for tools that all do some version of the same thing.</p>
          </motion.div>
          <motion.div variants={fadeInUp} className="bg-white border border-gray-200 p-8 rounded-xl shadow-sm">
             ...
             <p className="text-gray-600 text-sm leading-relaxed">Every new AI tool is another data processing agreement, another access review, another audit line item.</p>
          </motion.div>
          <motion.div variants={fadeInUp} className="bg-white border border-gray-200 p-8 rounded-xl shadow-sm">
             ...
             <p className="text-gray-600 text-sm leading-relaxed">A customer support conversation, an employee IT ticket and an HR question live in three tools that have never spoken to each other.</p>
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={fadeInUp} className="mb-16 max-w-3xl">
             ...
             <h2 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
               The alternative to five AI vendors is one platform
             </h2>
             <p className="text-lg text-gray-600 leading-relaxed">
               Support, IT, HR, sales and ops can each run on Kas newerax instead of a different point solution bought by a different team.
             </p>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="w-full flex flex-col lg:flex-row items-center justify-center gap-12 bg-white border border-gray-200 rounded-3xl p-12 shadow-sm">
             ...
             <div className="flex flex-col items-center w-full lg:w-1/3">
                ...
                <div className="w-full space-y-3">
                   ...
                   <div className="border border-red-200 bg-red-50 rounded-lg p-4 flex justify-between items-center shadow-sm">
                      <span className="text-xs font-bold text-gray-800">IT Helpdesk AI</span>
                      <X className="w-4 h-4 text-red-500" />
                   </div>
                   <div className="border border-red-200 bg-red-50 rounded-lg p-4 flex justify-between items-center shadow-sm">
                      <span className="text-xs font-bold text-gray-800">HR Assistant App</span>
                      <X className="w-4 h-4 text-red-500" />
                   </div>
                   <div className="border border-red-200 bg-red-50 rounded-lg p-4 flex justify-between items-center shadow-sm">
             ...
             <div className="flex flex-col items-center w-full lg:w-1/2 relative h-[300px] justify-center">
                ...
                <div className="flex items-center justify-between w-full h-full relative pl-4 mt-8">
                   <div className="flex flex-col justify-center gap-4 z-10 w-1/2">
                      ...
                      <div className="bg-white border border-[#0ea5e9] px-4 py-3 rounded-lg text-xs font-bold text-gray-800 shadow-sm text-center">IT</div>
                      <div className="bg-white border border-[#0ea5e9] px-4 py-3 rounded-lg text-xs font-bold text-gray-800 shadow-sm text-center">HR</div>
                      <div className="bg-white border border-[#0ea5e9] px-4 py-3 rounded-lg text-xs font-bold text-gray-800 shadow-sm text-center">SALES & OPS</div>
                   </div>
          ...
          <motion.p variants={fadeInUp} className="text-center text-sm font-bold text-gray-800 mt-8">
            Same five use cases. One contract, one integration, one team that owns it.
          </motion.p>
        </div>
      </motion.section>
      ...
      >
        <motion.div variants={fadeInUp} className="mb-16 max-w-3xl">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            An AI platform touches finance, engineering and customer experience at once - and now touches every department. Kas newerax is built to satisfy all three sign-offs, not add a fourth vendor to manage.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div variants={fadeInUp} className="border-t-4 border-[#6039ea] bg-white border-l border-r border-b border-gray-200 p-8 rounded-b-xl shadow-sm">
             ...
             <p className="text-gray-600 text-sm leading-relaxed">Every new department agent extends the platform you already pay for - one renewal, one budget line, instead of a new vendor contract every time a team wants automation.</p>
          </motion.div>
          <motion.div variants={fadeInUp} className="border-t-4 border-[#0ea5e9] bg-white border-l border-r border-b border-gray-200 p-8 rounded-b-xl shadow-sm">
             ...
             <h3 className="text-lg font-bold text-gray-900 mb-3">One integration layer, one security review</h3>
             <p className="text-gray-600 text-sm leading-relaxed">Every agent runs through the same platform, the same data agreement and the same access controls - not a new vendor risk assessment every time a department wants AI.</p>
          </motion.div>
          <motion.div variants={fadeInUp} className="border-t-4 border-[#10b981] bg-white border-l border-r border-b border-gray-200 p-8 rounded-b-xl shadow-sm">
             ...
             <h3 className="text-lg font-bold text-gray-900 mb-3">One system of record across every conversation</h3>
             <p className="text-gray-600 text-sm leading-relaxed">Support, IT and HR conversations live on the same platform, so nothing gets lost between tools that were never meant to talk to each other.</p>
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={fadeInUp} className="mb-16 max-w-3xl">
             ...
             <h2 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
               AI agents for every part of your business
             </h2>
             <p className="text-lg text-gray-600 leading-relaxed">
               Every agent runs on the same platform as your existing CX stack - support, IT, HR, sales and ops, without a separate vendor for each.
             </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
             {/* Agents 1-7 (White Cards) */}
             {[
               ...
               { id: "02", title: "Employee Helpdesk Agents", desc: "Answer internal questions instantly and route what needs a human." },
               { id: "03", title: "HR & Policy Assistants", desc: "Give employees instant, accurate answers on policy, benefits and leave." },
               { id: "04", title: "Sales Enablement Agents", desc: "Qualify leads, answer product questions and support reps in real time." },
               { id: "05", title: "IT Support Agents", desc: "Triage tickets, resolve common issues and escalate what needs a specialist." },
               { id: "06", title: "Knowledge Assistants", desc: "Turn your docs and wikis into an assistant that actually knows the answer." },
               { id: "07", title: "Operations & Workflow Agents", desc: "Automate approvals, handoffs and repetitive operational tasks." }
             ].map((agent, i) => (
             ...
             <motion.div variants={fadeInUp} className="bg-[#140f2d] border border-[#1e1642] p-6 rounded-xl shadow-sm">
                <p className="text-[9px] font-bold text-[#0ea5e9] tracking-widest uppercase mb-3">AGENT_08</p>
                <h4 className="text-base font-bold text-white mb-2">Custom AI agents for your business</h4>
                <p className="text-xs text-gray-400 leading-relaxed">Do not see your use case? We build agents around your exact workflow.</p>
             </motion.div>
          </div>
        </div>
      </motion.section>
      ...
      >
        <motion.div variants={fadeInUp} className="mb-20 max-w-3xl">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            A structured build process, run by the same team from first workshop to ongoing optimisation - with no engineering lift on your side.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
           {[
             ...
             { num: "03", title: "Build and integrate", desc: "We connect the agent to your CRM, helpdesk and internal systems - on the platform you already run." },
             { num: "04", title: "Test and deploy", desc: "We validate against real scenarios before it reaches a customer or employee." },
             { num: "05", title: "Optimise continuously", desc: "We monitor performance and refine the agent as your business changes." }
           ].map((step, i) => (
      ...
      >
        <motion.div variants={fadeInUp} className="mb-16 max-w-3xl">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Directional results teams see after rolling out Kas newerax AI agents. Actual impact depends on your starting ticket volume, systems and use case.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
           <motion.div variants={fadeInUp} className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm text-center md:text-left">
              <h3 className="text-4xl md:text-5xl font-bold text-[#6039ea] mb-2">85%</h3>
              <p className="text-xs text-gray-600 font-medium">Automated resolution rate</p>
           </motion.div>
           <motion.div variants={fadeInUp} className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm text-center md:text-left">
              <h3 className="text-4xl md:text-5xl font-bold text-[#6039ea] mb-2">60%</h3>
              <p className="text-xs text-gray-600 font-medium">Reduction in human handoff volume</p>
           </motion.div>
           <motion.div variants={fadeInUp} className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm text-center md:text-left">
              <h3 className="text-4xl md:text-5xl font-bold text-[#6039ea] mb-2">40%</h3>
              <p className="text-xs text-gray-600 font-medium">Improvement in CSAT</p>
           </motion.div>
           <motion.div variants={fadeInUp} className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm text-center md:text-left">
              <h3 className="text-4xl md:text-5xl font-bold text-[#6039ea] mb-2">Weeks</h3>
              <p className="text-xs text-gray-600 font-medium">Typical time to first live agent, not quarters</p>
           </motion.div>
        </div>
        <motion.p variants={fadeInUp} className="text-[10px] text-gray-400">
          Based on outcomes reported across the Kas newerax customer base. Results vary by starting volume, systems and use case.
        </motion.p>
      </motion.section>
      ...
      >
        <motion.div variants={fadeInUp} className="max-w-3xl">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
            The platform you already run, extended - not a new vendor
          </h2>
          <p className="text-lg text-gray-600 leading-relaxed">
            Custom agents are not a separate product or a separate relationship. They extend the platform already handling your support conversations.
          </p>
        </motion.div>
      </motion.section>
      ...
      >
        <div className="max-w-3xl mx-auto flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight leading-tight">
            Bring every department onto one AI platform
          </h2>
          <p className="text-base text-gray-400 mb-10 leading-relaxed max-w-2xl">
            A 30-minute workshop to map which departments are already paying for separate AI tools, and show your CFO, CTO and support lead exactly where consolidating onto Kas newerax pays for itself.
          </p>
